...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        ...
        <ul className='hidden md:flex items-start gap-18 font-bold'>
            
            <NavLink to='/'>
              <li className='py-1'>HOME</li>
              <hr className='border-none outline-none h-0.5 bg-red-300 w-3/5 m-auto hidden' />  
            </NavLink>
            <NavLink to='/doctors'>
            ...
            <NavLink to='http://localhost:5174/'>
              <li className='bg-blue-300 text-black px-6 py-3 rounded-full font-medium hidden md:block'>Admin</li>
              <hr className='border-none outline-none h-0.5 bg-red-300 w-3/5 m-auto hidden' />  
            </NavLink>
        ...
        <div className='flex items-center gap-4'>
            {
                ...
                :<button onClick={()=>navigate('/login')} className='bg-red-300 text-black px-8 py-3 rounded-full font-medium hidden md:block'>
                Create Account
                </button>
            }
