      ...
      {docInfo ? (
        <div>
          <div className='flex flex-col sm:flex-row gap-4'>
            <img
              className='bg-primary w-full sm:w-40 h-40 object-cover rounded-lg'
              src={docInfo.image}
          ...
          <div >
            ...
            <div className='flex items-center gap-2 text-sm mt-1 text-gray-600'>
              ...
              <button className='py-0.5 px-2 border text-xs rounded-full'>Working Experience - {docInfo.experience}</button>
            </div>
            <div>
          ...
          <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
            ...
            <div className='flex gap-3 items-center w-full overflow-x-scroll mt-4'>
              {
                docSlots.length > 0 && docSlots.map((item, index) => (
                  <div onClick={() => setSlotIndex(index)}
                    key={index}
                    className={`flex gap-2 text-center py-6 min-w-16 rounded-full cursor-pointer ${slotIndex === index ? 'bg-red-400 text-white' : 'border border-gray-200'
                      }`}
                  >
            ...
            <br />
            <button onClick={bookAppointment} className='bg-red-300 text-black text-sm font-light px-14 py-3 rounded-full my-6'>Book an appointment</button>
